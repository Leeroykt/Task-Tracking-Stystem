...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($stmt->rowCount() > 0) {
        ...
        $sql = "INSERT INTO admin_user (first_name, last_name, email, password) VALUES (:first_name, :last_name, :email, :password)";
        ...
        if ($stmt->execute()) {
            echo "Registration successful! Please <a href='login_admin.html'>login</a>.";
        } else {
                        ...
                        <div class="col-lg-7">
                            <div class="card shadow-lg border-0 rounded-lg mt-5">
                                ...
                                <div class="card-footer text-center py-3">
                                    <div class="small"><a href="login_admin.php">Have an account? Go to login</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
